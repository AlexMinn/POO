...
public class VendingMachineTest {
	...
	String credencial="A156Bv09_1zXo894";
...
VendingMachine m1 = new VendingMachine(0,true,2,20);
	...
	public void testMeterProductosIdentificadorIncorrecto() {
		...
		Product p1 = new  Product(nombre, crearFechaPorDefecto(), upcValido, 8);
		Linea l1 = new Linea(0,p1,5,2);
		Linea l2 = new Linea(1,p1,7,0);
		m1.nuevaLinea(l1);
		m1.nuevaLinea(l2);
	...
	public void testSacarCantidadCorrecta() {
		...
		Product p1 = new  Product(nombre, crearFechaPorDefecto(), upcValido, 5);
		Linea l1 = new Linea(0,p1,5,6);
		Linea l2 = new Linea(1,p1,2,0);
		m1.nuevaLinea(l1);
		m1.nuevaLinea(l2);
		
		TarjetaMonedero visa = new TarjetaMonedero(credencial,20.0);
	...
	public void testSacarCantidadIdentificadorIncorrecto() {
		...
		TarjetaMonedero visa = new TarjetaMonedero(credencial,2000.0);
	...
	public void testSacarCantidadDineroInsuficiente() {
		...
		TarjetaMonedero visa = new TarjetaMonedero(credencial,9.0);
	...
	public void testSacarCantidadDineroJusto() {
		...
		TarjetaMonedero visa = new TarjetaMonedero(credencial,10.0);
